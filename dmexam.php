            ...
            <div class="contentwrapper"><!--Content wrapper-->
                ...
                <div class="heading">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="active">DM/Mch Exams</li>
                    </ul>
					...
					<div class="span12">
                            ...
                            foreach($specialitylist as $speciality){
                            	echo '<tr>
                                    ...
                                    <td><a href="dmposts.php?sid='.$speciality->getSpecialityid().'">'.$speciality->getSpecialitylabel().'</a></td>
                                    <td>'.showCountOfDMExamPosts($speciality->getSpecialityid()).'</td>
                                  </tr>';
                            	$index++;
                            }
                            ?>
