...
$sid = $_GET['sid'];
$specialitydata = getCollegeMasterList($sid);
...
?>
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <a href="examques.php" class="tip" title="Back to Exam Question Papers">
                                Forums
                            </a> 
                            <span class="divider">
                                <span class="icon16 icomoon-icon-arrow-right"></span>
                        ...
                        <li>
                            <a href="examquesposts.php?sid=<?php echo $sid?>" class="tip" title="Back to <?php echo $speciality->getSpecialitylabel()?>">
                        ...
                        <li class="active">Add Exam Question Papers</li>
                    </ul>
                ...
                <div class="row-fluid">
                            ...
                            <div class="box">
                                ...
                                <div class="content">
                                    ...
                                    <form id="addform" class="form-horizontal" method="post" action="processexamquesposts.php"  enctype="multipart/form-data" />
                                ...
                                <div class="span12">
                                    <div class="row-fluid">
                                        <label class="form-label span3" for="postlabel">Post Heading:</label>
                            ...
                            <div class="form-row row-fluid">
                                            <div class="span12">
                                                <div class="row-fluid">
                                                    <label class="form-label span3" for="textarea">Post: </label>
                                ...
                                <div class="span12">
                                    <div class="row-fluid">
                                        <label class="form-label span3" for="username">Question Paper(pdf/ppt/doc only):</label>
                                ...
                                <div class="span12">
                                    <div class="row-fluid">
                                        ...
                                        <div class="span4 controls">
                                            <button type="submit" class="btn btn-info marginR10">Add Exam Question Paper</button>
                                            <a href="examquesposts.php?sid=<?php echo $sid?>" class="btn btn-danger">Cancel</a>
                                        </div>
                                        </div>
                                    </div>
                                </div>   
