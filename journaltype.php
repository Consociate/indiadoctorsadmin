					...
					<div class="span12">
                            ...
                            <table class="responsive table table-bordered">
                                ...
                                <?php 
                                	...
                                	$nationalcount = showCountOfJournalNationalPosts($sid);
                                	$intercount = showCountOfJournalInterNationalPosts($sid);
                                ?>
                                <tr>
                                  	<td>1</td>
                                    <td><a href="journalposts.php?sid=<?php echo $sid?>&type=1">National</a></td>
                                    <td><?php echo $nationalcount?></td>
                                  </tr>
                                  <tr>
                                  	<td>2</td>
                                    <td><a href="journalposts.php?sid=<?php echo $sid?>&type=2">International</a></td>
