...
?>
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <a href="images.php" class="tip" title="Back to Images">
                                Images
                            </a> 
                            <span class="divider">
                                <span class="icon16 icomoon-icon-arrow-right"></span>
                        ...
                        <li>
                            <a href="imagesposts.php?sid=<?php echo $sid?>" class="tip" title="Back to <?php echo $speciality->getSpecialitylabel()?>">
                ...
                <div class="row-fluid">
                            ...
                            <div class="box">
                                ...
                                <div class="content">
                                    ...
                                    <form id="addform" class="form-horizontal" method="post" action="processimages.php" enctype="multipart/form-data" />
                                ...
                                <div class="span12">
                                    <div class="row-fluid">
                                        <label class="form-label span3" for="postlabel">Image Name:</label>
                            ...
                            <div class="form-row row-fluid">
                                            <div class="span12">
                                                <div class="row-fluid">
                                                    <label class="form-label span3" for="textarea">Image Details: </label>
                                ...
                                <div class="span12">
                                    <div class="row-fluid">
                                        ...
                                        <div class="span4 controls">
                                            <button type="submit" class="btn btn-info marginR10">Add Image</button>
                                            <a href="imagesposts.php?sid=<?php echo $sid?>" class="btn btn-danger">Cancel</a>
                                        </div>
                                        </div>
                                    </div>
                                </div>   
