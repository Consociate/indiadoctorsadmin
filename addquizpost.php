...
?>
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <a href="quizposts.php?sid=<?php echo $sid?>" class="tip" title="Back to <?php echo $speciality->getSpecialitylabel()?>">
                ...
                <div class="row-fluid">
                            ...
                            <div class="box">
                                ...
                                <div class="content">
                                    ...
                                    <form id="addform" class="form-horizontal" method="post" action="processquizposts.php" />
                                ...
                                <div class="span12">
                                    <div class="row-fluid">
                                        <label class="form-label span3" for="postlabel">Quiz Title:</label>
                                        <input class="span4" id="postlabel" maxlength="100" name="postlabel" type="text" placeholder="Enter heading" />
                                    </div>
                                </div>
                            </div>
                            <div class="form-row row-fluid">
                                            <div class="span12">
                                                <div class="row-fluid">
                                                    <label class="form-label span3" for="textarea">Question: </label>
                                                    <textarea class="span8 tinymce" id="textarea1" name="post" rows="10" cols="10"></textarea>
                                                </div>
                                            </div>  
                                        </div>
                            <div class="form-row row-fluid">
                                <div class="span12">
                                    <div class="row-fluid">
                                        <label class="form-label span3" for="postlabel">Option 1:</label>
                                        <input class="span4" id="option1" maxlength="100" name="option1" type="text" placeholder="Enter heading" />
                                    </div>
                                </div>
                            </div>
                            <div class="form-row row-fluid">
                                <div class="span12">
                                    <div class="row-fluid">
                                        <label class="form-label span3" for="postlabel">Option 2:</label>
                                        <input class="span4" id="option2" maxlength="100" name="option2" type="text" placeholder="Enter heading" />
                                    </div>
                                </div>
                            </div>
                            <div class="form-row row-fluid">
                                <div class="span12">
                                    <div class="row-fluid">
                                        <label class="form-label span3" for="postlabel">Option 3:</label>
                                        <input class="span4" id="option3" maxlength="100" name="option3" type="text" placeholder="Enter heading" />
                                    </div>
                                </div>
                            </div>
                            <div class="form-row row-fluid">
                                <div class="span12">
                                    <div class="row-fluid">
                                        <label class="form-label span3" for="postlabel">Option 4:</label>
                                        <input class="span4" id="option4" maxlength="100" name="option4" type="text" placeholder="Enter heading" />
                                    </div>
                                </div>
                            </div>
                            <div class="form-row row-fluid">
                                <div class="span12">
                                    <div class="row-fluid">
                                        <label class="form-label span3" for="postlabel">Correct Answer:</label>
                                        <select class="span4" id="correctanswer" name="correctanswer"   >
                            ...
                            <div class="form-row row-fluid">
                                            <div class="span12">
                                                <div class="row-fluid">
                                                    <label class="form-label span3" for="textarea">Explanation: </label>
                                                    <textarea class="span8 tinymce" id="textarea" name="explanation" rows="10" cols="10"></textarea>
                                                </div>
                                            </div>  
                                        </div>
                               <div class="form-row row-fluid">        
                                <div class="span12">
                                    <div class="row-fluid">
                                        ...
                                        <div class="span4 controls">
                                            <button type="submit" class="btn btn-info marginR10">Add Question</button>
                                            <a href="dmposts.php?sid=<?php echo $sid?>" class="btn btn-danger">Cancel</a>
                                        </div>
                                        </div>
                                    </div>
                                </div>   
...
$(function(){
	$('#addform').submit(function(){
		var postlabel =  $('#postlabel').val();
		if(postlabel.length <2 && postlabel == ""){
			$('.error_message').html('Please enter title for the post.');
			return false;
		}
			return true;
		});
