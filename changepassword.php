                ...
                <div class="row-fluid">
					...
					<?php 
                        	if($_GET['eid']==1){
                                ...
                                <button type="button" class="close" data-dismiss="alert">&times;</button>
                                <strong>Oh snap!</strong> Error updating password. The length of the password should be more than 6 characters. Please try again later.
                            </div>
                        		<?php 
                        	}
                        ?>
                    ...
                    <div class="span12">
                            ...
                            <div class="box">
                                ...
                                <div class="span12">
                                    <div class="row-fluid">
                                        <label class="form-label span3" for="username">Old Password:</label>
                                        <input class="span4" id="oldpassword" type="password" name="oldpassword" />
                                    </div>
                                </div>
                            </div>
                            <div class="form-row row-fluid">
                                <div class="span12">
                                    <div class="row-fluid">
                                        <label class="form-label span3" for="username">New Password(more than 6 characters):</label>
                                        <input class="span4" id="newpassword" type="password"  name="newpassword"/>
                                    </div>
                                </div>
                            </div>
                                        <div class="form-row row-fluid">        
