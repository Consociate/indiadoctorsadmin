                ...
                <div class="row-fluid">
					...
					<div class="span12">
                            ...
                            foreach($specialitylist as $speciality){
                            	$nationalcount = showCountOfGuidelinesNationalPosts($speciality->getSpecialityid());
                                	$intercount = showCountOfGuidelinesInterNationalPosts($speciality->getSpecialityid()); 
                            	echo '<tr>
                                    <td style="text-align:left;">'.($index+1).'</td>
                                    <td><a href="guidelinestype.php?sid='.$speciality->getSpecialityid().'">'.$speciality->getSpecialitylabel().'</a></td>
                                    <td>'.($nationalcount+$intercount).'</td>
                                  </tr>';
                            	$index++;
                            }
                            ?>
