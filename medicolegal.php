            ...
            <div class="contentwrapper"><!--Content wrapper-->
                ...
                <div class="heading">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="active">Medico-Legal</li>
                    </ul>
                ...
                <div class="row-fluid">
                        ...
                        <div class="centerContent">
                            ...
                            <ul class="bigBtnIcon">
                                <li>
                                    <a href="addmedicolegalpost.php" title="Add Post" class="tipB">
					...
					<?php 
                        	if($_GET['eid']==1){
                                ...
                                <strong>Your Medico-Legal Post Updated!</strong> 
                            </div>
                        		<?php 
                        	}else if($_GET['eid']==2){
                        		?>
					...
					<div class="span12">
                            ...
                            $postlist = showMedicoLegalPosts();
                            $index = 0;
                            foreach($postlist as $post){
                            	echo '<tr>
                                    <td style="text-align:left;">'.($index+1).'</td>
                                    <td><a href="medicolegalpost.php?tid='.$post->getTid().'"><span class="icon16 iconic-icon-book-alt2"></span>'.$post->getPostlabel().'</a></td>
                                    <td>'.$post->getCreatedby().'</td>';
                            		if($role == USER_ADMIN){
                            			echo '<td><a href="processmedicolegalposts.php?action=3&tid='.$post->getTid().'&st=0" title="Remove This" class="tip">
