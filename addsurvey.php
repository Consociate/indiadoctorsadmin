            ...
            <div class="contentwrapper"><!--Content wrapper-->
                ...
                <div class="heading">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <a href="surveys.php" class="tip" title="Back to Surveys">
                                Surveys
                            </a> 
                            <span class="divider">
                                <span class="icon16 icomoon-icon-arrow-right"></span>
                            ...
                            <div class="box">
                                ...
                                <div class="content">
                                   ...
                                   $action = $_SERVER['PHP_SELF'];
                                   	if(isset($_POST['noofoptions'])){
                                   		$noofoptions = $_POST['noofoptions'];
                                   		$action = "processsurveypost.php";
                                   		$question = $_POST['postlabel'];
                                   	}
                                   ?>
                                    <form id="addform" class="form-horizontal" method="post" action="<?php echo $action?>" />
                                    <input type="hidden" name="action" id="action" value="1" />
                                     <p class="error_message" style="color: red;"></p>
                                    <div class="form-row row-fluid">
                                <div class="span12">
                                    <div class="row-fluid">
                                        <label class="form-label span3" for="postlabel">Question:</label>
                                        <input class="span4" id="postlabel" maxlength="100" name="postlabel" type="text" value="<?php echo $question?>" placeholder="Enter heading" />
                                    </div>
                                </div>
                            </div>
                            <?php 
                            	if($noofoptions){
                            		echo '<input type="hidden" name="noofoptions" id="noofoptions" value="'.$noofoptions.'" />';
                            	}else{
                            ?>
                            <div class="form-row row-fluid">
                                <div class="span12">
                                    <div class="row-fluid">
                                        <label class="form-label span3" for="noofoptions">No. Of Options:</label>
                                        <input class="span4" id="noofoptions" maxlength="1" name="noofoptions" type="text" placeholder="Enter heading" />
                                    </div>
                                </div>
                            </div>
                            <?php 
                            	...
                            	if($noofoptions){
                            		for($i=0; $i<$noofoptions; $i++){
		                                ...
		                                <div class="span12">
		                                    <div class="row-fluid">
		                                        <label class="form-label span3" for="noofoptions">Option '.($i+1).':</label>
		                                        <input class="span4" id="option'.($i+1).'" maxlength="100" name="option'.($i+1).'" type="text" placeholder="Enter option" />
		                                    </div>
		                                </div>
		                            </div>';
                            		}
                                ...
                                <div class="span12">
                                    <div class="row-fluid">
                                        ...
                                        <div class="span4 controls">
                                            <button type="submit" class="btn btn-info marginR10">Add Surveys</button>
                                            <a href="surveys.php" class="btn btn-danger">Cancel</a>
                                        </div>
                                        </div>
                                    </div>
                                </div>   
