					...
					<div class="span12">
                            ...
                            foreach($specialitylist as $speciality){
                            	echo '<tr>
                                    ...
                                    <td><a href="forumposts.php?sid='.$speciality->getSpecialityid().'">'.$speciality->getSpecialitylabel().'</a></td>
                                    <td>'.showNumberOfForumPostsPerSpeciality($speciality->getSpecialityid()).'</td>
                                  </tr>';
                            	$index++;
                            }
                            ?>
