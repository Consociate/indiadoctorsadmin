            ...
            <div class="contentwrapper"><!--Content wrapper-->
                ...
                <div class="heading">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <a href="implinks.php" class="tip" title="Back to Important Links">
                                Important Links
                            </a> 
                            <span class="divider">
                                <span class="icon16 icomoon-icon-arrow-right"></span>
                        ...
                        <li class="active">Add Important Links</li>
                    </ul>
                ...
                <div class="row-fluid">
                            ...
                            <div class="box">
                                ...
                                <div class="content">
                                    ...
                                    <form id="addform" class="form-horizontal" method="post" action="processimplinks.php"  enctype="multipart/form-data"/>
                            ...
                            <div class="form-row row-fluid">
                                ...
                                <div class="span12">
                                    <div class="row-fluid">
                                        <label class="form-label span3" for="linkpath">Link:</label>
                                        <input class="span4" id="linkpath" name="linkpath" type="text" placeholder="Enter heading" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="span12">
                                    <div class="row-fluid">
                                        <label class="form-label span3" for="username">Upload Document:</label>
                                ...
                                <div class="span12">
                                    <div class="row-fluid">
                                        ...
                                        <div class="span4 controls">
                                            <button type="submit" class="btn btn-info marginR10">Add Link</button>
                                            <a href="implinks.php" class="btn btn-danger">Cancel</a>
                                        </div>
                                        </div>
                                    </div>
                                </div>   
