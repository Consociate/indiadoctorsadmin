...
?>
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <a href="conferences.php" class="tip" title="Back to Conferences">
                                Conferences
                            </a> 
                            <span class="divider">
                                <span class="icon16 icomoon-icon-arrow-right"></span>
                        ...
                        <li>
                            <a href="conferenceposts.php?sid=<?php echo $sid?>" class="tip" title="Back to <?php echo $speciality->getSpecialitylabel()?>">
                ...
                <div class="row-fluid">
                            ...
                            <div class="box">
                                ...
                                <div class="title">
                                    ...
                                    <h4>
                                        ...
                                        <span>Add Conferences</span>
                                    </h4>
                                    
                                </div>
                                <div class="content">
                                   
                                    <form id="addform" class="form-horizontal" method="post" action="processconferenceposts.php" />
                                ...
                                <div class="span12">
                                    <div class="row-fluid">
                                        <label class="form-label span3" for="postlabel">Conference Name:</label>
                            ...
                            <div class="form-row row-fluid">
                                            <div class="span12">
                                                <div class="row-fluid">
                                                    <label class="form-label span3" for="textarea">Conference Details(Overview and Link): </label>
                                ...
                                <div class="span12">
                                    <div class="row-fluid">
                                        ...
                                        <div class="span4 controls">
                                            <button type="submit" class="btn btn-info marginR10">Add Conference</button>
                                            <a href="conferenceposts.php?sid=<?php echo $sid?>" class="btn btn-danger">Cancel</a>
                                        </div>
                                        </div>
                                    </div>
                                </div>   
