...
?>
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <a href="journal.php" class="tip" title="Back to Journals">
                                Journals
                            </a> 
                            <span class="divider">
                                <span class="icon16 icomoon-icon-arrow-right"></span>
                        ...
                        <li>
                            <a href="journaltype.php?sid=<?php echo $sid ?>&type=<?php echo $type?>" class="tip" title="Back to <?php echo $speciality->getSpecialitylabel()?>">
						...
						?>
                        	<a href="journalposts.php?sid=<?php echo $sid ?>&type=<?php echo $type?>" class="tip" title="Back to <?php echo $journaltype?>">
                ...
                <div class="row-fluid">
                            ...
                            <div class="box">
                                ...
                                <div class="content">
                                    ...
                                    <form id="addform" class="form-horizontal" method="post" action="processjournalpost.php"  enctype="multipart/form-data" />
                                ...
                                <div class="span12">
                                    <div class="row-fluid">
                                        <label class="form-label span3" for="postlabel">Journal Name:</label>
                            ...
                            <div class="form-row row-fluid">
                                            <div class="span12">
                                                <div class="row-fluid">
                                                    <label class="form-label span3" for="textarea">Journal Details: </label>
                                ...
                                <div class="span12">
                                    <div class="row-fluid">
                                        <label class="form-label span3" for="username">Details(doc/pdf/ppt files):</label>
                                ...
                                <div class="span12">
                                    <div class="row-fluid">
                                        ...
                                        <div class="span4 controls">
                                            <button type="submit" class="btn btn-info marginR10">Add Journal</button>
                                            <a href="journalposts.php?sid=<?php echo $sid?>&type=<?php echo $type?>" class="btn btn-danger">Cancel</a>
                                        </div>
                                        </div>
                                    </div>
                                </div>   
