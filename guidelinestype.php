					...
					<div class="span12">
                            ...
                            <table class="responsive table table-bordered">
                                ...
                                <?php 
                                	...
                                	$nationalcount = showCountOfGuidelinesNationalPosts($sid);
                                	$intercount = showCountOfGuidelinesInterNationalPosts($sid);
                                ?>
                                <tr>
                                  	<td>1</td>
                                    <td><a href="guidelinesposts.php?sid=<?php echo $sid?>&type=1">National</a></td>
                                    <td><?php echo $nationalcount?></td>
                                  </tr>
                                  <tr>
                                  	<td>2</td>
                                    <td><a href="guidelinesposts.php?sid=<?php echo $sid?>&type=2">International</a></td>
                                    <td><?php echo $intercount?></td>
                                  </tr>
                                </tbody>
                            </table>
                        </div>
