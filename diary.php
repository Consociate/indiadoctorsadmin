            ...
            <div class="contentwrapper"><!--Content wrapper-->
                ...
                <div class="heading">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="active">Admin Diary</li>
                    </ul>
                ...
                <div class="row-fluid">
                        ...
                        <div class="centerContent">
                            ...
                            <ul class="bigBtnIcon">
                                <li>
                                    <a href="adddiary.php" title="Add Entry" class="tipB">
                                        <span class="icon brocco-icon-plus"></span>
                                        <span class="txt">Add Entry</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
					...
					<?php 
                        	if($_GET['eid']==1){
                                ...
                                <button type="button" class="close" data-dismiss="alert">&times;</button>
                                <strong>Oh snap!</strong> Error updating diary. Please try again later.
                            </div>
                        		<?php 
                        	}
                        ?>
					...
					<div class="span12">
                            ...
                            $postlist = showDiaryPosts();
                            $index = 0;
                            foreach($postlist as $post){
                            	echo '<tr>
                                    <td style="text-align:left;">'.($index+1).'</td>
                                    <td><a href="diarypost.php?tid='.$post->getTid().'">'.$post->getPostlabel().'</a></td>
                                    <td>'.date('d-m-Y', strtotime($post->getDateofaddition())).'</td>
                                    <td>'.$post->getCreatedby().'</td>';
                            if($role == USER_ADMIN){
                            			echo '<td><a href="processdiary.php?action=3&tid='.$post->getTid().'&st=0" title="Remove This" class="tip">
