...
?>
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <a href="dmexam.php" class="tip" title="Back to DM Questions">
                                DM/Mch Questions
                            </a> 
                            <span class="divider">
                                <span class="icon16 icomoon-icon-arrow-right"></span>
                        ...
                        <li>
                            <a href="dmposts.php?sid=<?php echo $sid?>" class="tip" title="Back to <?php echo $speciality->getSpecialitylabel()?>">
                ...
                <div class="row-fluid">
                            ...
                            <div class="box">
                                ...
                                <div class="content">
                                    ...
                                    <form id="addform" class="form-horizontal" method="post" action="processdmexamposts.php" />
