        ...
        <div id="content" class="clearfix">
            <div class="contentwrapper"><!--Content wrapper-->
                ...
                <div class="heading">
                    ...
                    <h3>Share Profile Information</h3>                    
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="active">Share Profile Information</li>
                    </ul>
                ...
                <div class="row-fluid">
					...
					<?php 
                        	if($_GET['eid']==1){
                                ...
                                <button type="button" class="close" data-dismiss="alert">&times;</button>
                                <strong>Oh snap!</strong> Error updating settings. Please try again later.
                            </div>
                        		<?php 
                        	}
                        ?>
                    ...
                    <div class="span12">
                        ...
                        <form class="form-horizontal seperator" enctype="multipart/form-data" method="post" action="processshare.php"/>
                            <div class="form-row row-fluid">
                                <div class="span12">
                                    <div class="row-fluid">
                                        <label class="form-label span3" for="gender">Personal Profile:</label>
                                        <?php 
                                        	switch(fetchShareSettingForUserForOnePermission($_SESSION['uid'], SHARE_PROFILE)){
                                        		case 1:
                                        			?>
                                        			<div class="left marginT5 marginR10">
                                            <input type="radio" name="profile" id="optionsRadios1" value="1" checked="checked" />
                                            Public
                                        </div>
                                        <div class="left marginT5 marginR10">
                                            <input type="radio" name="profile" id="optionsRadios2" value="2" />
                                            Private
                                        </div>
                                        			<?php 
                                        			break;
                                        		case 2:
                                        			?>
                                        			<div class="left marginT5 marginR10">
                                            <input type="radio" name="profile" id="optionsRadios1" value="1" />
                                            Public
                                        </div>
                                        <div class="left marginT5 marginR10">
                                            <input type="radio" name="profile" id="optionsRadios2" value="2"  checked="checked"/>
                                            Private
                                        </div>
                                        			<?php 
                                        			break;
default:
	?>
                            ...
                            <div class="form-row row-fluid">
                                <div class="span12">
                                    <div class="row-fluid">
                                        <label class="form-label span3" for="gender">CV:</label>
                                        <?php 
                                        	switch(fetchShareSettingForUserForOnePermission($_SESSION['uid'], SHARE_CV)){
                                        		case 1:
                                        			?>
                                        			<div class="left marginT5 marginR10">
                                            <input type="radio" name="cv" id="optionsRadios1" value="1" checked="checked" />
                                            Public
                                        </div>
                                        <div class="left marginT5 marginR10">
                                            <input type="radio" name="cv" id="optionsRadios2" value="2" />
                                            Private
                                        </div>
                                        			<?php 
                                        			break;
                                        		case 2:
                                        			?>
                                        			<div class="left marginT5 marginR10">
                                            <input type="radio" name="cv" id="optionsRadios1" value="1" />
                                            Public
                                        </div>
                                        <div class="left marginT5 marginR10">
                                            <input type="radio" name="cv" id="optionsRadios2" value="2"  checked="checked"/>
                                            Private
                                        </div>
                                        			<?php 
                                        			break;
default:
	?>
                            ...
                            <div class="form-row row-fluid">
                                <div class="span12">
                                    <div class="row-fluid">
                                        <label class="form-label span3" for="gender">Education Details:</label>
                                        <?php 
                                        	switch(fetchShareSettingForUserForOnePermission($_SESSION['uid'], SHARE_EDU)){
                                        		case 1:
                                        			?>
                                        			<div class="left marginT5 marginR10">
                                            <input type="radio" name="edu" id="optionsRadios1" value="1" checked="checked" />
                                            Public
                                        </div>
                                        <div class="left marginT5 marginR10">
                                            <input type="radio" name="edu" id="optionsRadios2" value="2" />
                                            Private
                                        </div>
                                        			<?php 
                                        			break;
                                        		case 2:
                                        			?>
                                        			<div class="left marginT5 marginR10">
                                            <input type="radio" name="edu" id="optionsRadios1" value="1" />
                                            Public
                                        </div>
                                        <div class="left marginT5 marginR10">
                                            <input type="radio" name="edu" id="optionsRadios2" value="2"  checked="checked"/>
                                            Private
                                        </div>
                                        			<?php 
                                        			break;
...
<div class="form-row row-fluid">
                                <div class="span12">
                                    <div class="row-fluid">
                                        <label class="form-label span3" for="gender">Workplace Details:</label>
                                        <?php 
                                        	switch(fetchShareSettingForUserForOnePermission($_SESSION['uid'], SHARE_WORK)){
                                        		case 1:
                                        			?>
                                        			<div class="left marginT5 marginR10">
                                            <input type="radio" name="work" id="optionsRadios1" value="1" checked="checked" />
                                            Public
                                        </div>
                                        <div class="left marginT5 marginR10">
                                            <input type="radio" name="work" id="optionsRadios2" value="2" />
                                            Private
                                        </div>
                                        			<?php 
                                        			break;
                                        		case 2:
                                        			?>
                                        			<div class="left marginT5 marginR10">
                                            <input type="radio" name="work" id="optionsRadios1" value="1" />
                                            Public
                                        </div>
                                        <div class="left marginT5 marginR10">
                                            <input type="radio" name="work" id="optionsRadios2" value="2"  checked="checked"/>
                                            Private
                                        </div>
                                        			<?php 
                                        			break;
default:
	?>
                             ...
                             <div class="form-row row-fluid">
                                <div class="span12">
                                    <div class="row-fluid">
                                        <label class="form-label span3" for="gender">Speciality Details:</label>
                                        <?php 
                                        	switch(fetchShareSettingForUserForOnePermission($_SESSION['uid'], SHARE_SPEC)){
                                        		case 1:
                                        			?>
                                        			<div class="left marginT5 marginR10">
                                            <input type="radio" name="spec" id="optionsRadios1" value="1" checked="checked" />
                                            Public
                                        </div>
                                        <div class="left marginT5 marginR10">
                                            <input type="radio" name="spec" id="optionsRadios2" value="2" />
                                            Private
                                        </div>
                                        			<?php 
                                        			break;
                                        		case 2:
                                        			?>
                                        			<div class="left marginT5 marginR10">
                                            <input type="radio" name="spec" id="optionsRadios1" value="1" />
                                            Public
                                        </div>
                                        <div class="left marginT5 marginR10">
                                            <input type="radio" name="spec" id="optionsRadios2" value="2"  checked="checked"/>
                                            Private
                                        </div>
                                        			<?php 
                                        			break;
                                ...
                                <div class="span12">
                                    <div class="row-fluid">
                                        ...
                                        <div class="span4 controls">
                                            <button type="submit" class="btn btn-info marginR10">Save Settings</button>
