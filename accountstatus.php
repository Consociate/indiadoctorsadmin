                ...
                <div class="row-fluid">
                    ...
                    <div class="span12">
                        ...
                        <?php 
                        	...
                        	activateAccount($_GET['i']);
                        ?>
                        		<div class="alert alert-success">
                                <button type="button" class="close" data-dismiss="alert">&times;</button>
                                <strong>Well done!</strong> Your account has been activated.
                                 You can login using the username and the password that you mentioned at the time of registration. <a href="index.php">Login</a>
                            </div>
