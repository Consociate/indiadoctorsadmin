        ...
        <div id="content" class="clearfix">
            <div class="contentwrapper"><!--Content wrapper-->
                ...
                include_once 'src/controllers/newscontroller.php';
                	$postdetails = showInterNationalNews($tid);
                	$post = $postdetails[0];
                ?>
					...
					<?php 
                        ...
                        <div class="span12">
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" class="responsive forumTable display table table-bordered" width="100%">
                                        ...
                                        <tbody>
                                <?php 
                            $postlist = showInternationalNewsCommentsForPost($tid);//($sid);
                            $index = 0;
                            ...
                            <div class="box">
                                ...
                                <div class="content">
                                <form class="form-horizontal" method="post" action="processinternationalnews.php" />
