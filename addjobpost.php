            ...
            <div class="contentwrapper"><!--Content wrapper-->
                ...
                <div class="heading">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="active">Add Job Opening</li>
                    </ul>
                ...
                <div class="row-fluid">
                            ...
                            <div class="box">
                                ...
                                <div class="content">
                                    ...
                                    <form id="addform" class="form-horizontal" method="post" action="processjobposts.php" />
                                    <input type="hidden" name="action" id="action" value="1" />
                                     <p class="error_message" style="color: red;"></p>
                                    <div class="form-row row-fluid">
                                <div class="span12">
                                    <div class="row-fluid">
                                        <label class="form-label span3" for="postlabel">Heading:</label>
                            ...
                            <div class="form-row row-fluid">
                                            <div class="span12">
                                                <div class="row-fluid">
                                                    <label class="form-label span3" for="textarea">Opening Details: </label>
                                ...
                                <div class="span12">
                                    <div class="row-fluid">
                                        ...
                                        <div class="span4 controls">
                                            <button type="submit" class="btn btn-info marginR10">Add Opening</button>
                                            <a href="jobposts.php" class="btn btn-danger">Cancel</a>
                                        </div>
                                        </div>
                                    </div>
                                </div>   
