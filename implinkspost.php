				...
				<div class="span12">
                            ...
                            <div class="box">
                                ...
                                <h4>Dated: <?php echo date('d-m-Y', strtotime($post->getDateofaddition()))?></h4>
                                    ...
                                    <p><a href="<?php echo $post->getPathurl()?>" target="_blank">See Here</a></p>
                                    <p><a href="<?php echo IMPLINKS_UPLOAD_FOLDER_PATH.$post->getDocpath()?>" target="_blank">See Document Here</a></p>
                                </div>
