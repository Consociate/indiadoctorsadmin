            ...
            <div class="contentwrapper"><!--Content wrapper-->
                ...
                <div class="heading">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="active">National News</li>
                    </ul>
                ...
                ?>
                        ...
                        <div class="centerContent">
                            ...
                            <ul class="bigBtnIcon">
                                <li>
                                    <a href="addnationalnews.php" title="Add Post" class="tipB">
					...
					<div class="span12">
                            ...
                            $postlist = showNationalNews();
                            $index = 0;
                            foreach($postlist as $post){
                            	echo '<tr>
                                    <td style="text-align:left;">'.($index+1).'</td>
                                    <td><a href="nationalnewspost.php?tid='.$post->getTid().'">'.$post->getPostlabel().'</a></td>
                                    <td>'.date('d-m-Y', strtotime($post->getDateofaddition())).'</td>
                                    <td>'.$post->getCreatedby().'</td>';
                            	if($role == USER_ADMIN){
                            			echo '<td><a href="processnationalnews.php?action=3&tid='.$post->getTid().'&st=0" title="Remove This" class="tip">
