            ...
            <div class="contentwrapper"><!--Content wrapper-->
                ...
                <div class="heading">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <a href="adverts.php" class="tip" title="Back to Images">
                                Advertisements
                            </a> 
                        </li>
                ...
                <div class="row-fluid">
                            ...
                            <div class="box">
                                ...
                                <div class="title">
                                    ...
                                    <h4>
                                        ...
                                        <span>Add Advertisements</span>
                                    </h4>
                                    
                                </div>
                                <div class="content">
                                   
                                    <form class="form-horizontal" method="post" action="processadverts.php" enctype="multipart/form-data" />
                                    <input type="hidden" name="action" id="action" value="1" />
                                    <input type="hidden" name="sid" id="sid" value="<?php echo $sid?>" />
                                    <div class="form-row row-fluid">
                                <div class="span12">
                                    <div class="row-fluid">
                                        <label class="form-label span3" for="postlabel">Advertisement Link:</label>
                            ...
                            <div class="form-row row-fluid">
                                            <div class="span12">
                                                <div class="row-fluid">
                                                    <label class="form-label span3" for="textarea">Advertisement Slot: </label>
                                                    <select name="slot" id="slot">
                                                    	<option value="<?php echo AD_SLOT_BELOW_EDITORS_POST?>">Below Editor's Post</option>
                                                    	<option value="<?php echo AD_SLOT_BELOW_USER_ACTIVITY?>">Below User Activity</option>
                                                    	<option value="<?php echo AD_SLOT_BELOW_SIDE_SCROLL?>">Below Side Scroll</option>
                                                    </select>
                                                </div>
                                            </div>  
                                        </div>
                                ...
                                <div class="span12">
                                    <div class="row-fluid">
                                        ...
                                        <div class="span4 controls">
                                            ...
                                            <a href="adverts.php" class="btn btn-danger">Cancel</a>
                                        </div>
                                        </div>
                                    </div>
                                </div>   
