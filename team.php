                ...
                <div class="row-fluid">
					...
					<?php 
                        	if($_GET['eid']==1){
                                ...
                                <strong>Team Member Updated!</strong> 
                            </div>
                        		<?php 
                        	}else if($_GET['eid']==2){
                        		?>
                                ...
                                <button type="button" class="close" data-dismiss="alert">&times;</button>
                                <strong>Oh snap!</strong> Error updating team member. Please try again later.
                            </div>
                        		<?php 
                        	}
                        ?>
                                        ...
                                        include_once 'src/controllers/websitecontroller.php';
                                        	...
                                        	foreach ($quallist as $qual){
                                        		...
                                        		echo '<tr>
		                                            <td>'.($index+1).'</td>
		                                            <td>'.$qual->getName().'</td>
		                                            <td>'.$qual->getDescription().'</td>
		                                            <td>'.$qual->getOrderonwebsite().'</td>
		                                            <td>'.$status.'</td>
		                                            <td>
		                                                <div class="controls center">
		                                                <a href="processteam.php?action=3&tid='.$qual->getMemberid().'&st=1" title="Activate This" class="tip">
                                    <span class="icon12 brocco-icon-plus"></span>
                                    </a>
		                                                    <a href="processteam.php?action=3&tid='.$qual->getMemberid().'&st=0" title="Remove This" class="tip"><span class="icon12 icomoon-icon-remove"></span></a>
		                                                </div>
		                                            </td>
		                                          </tr>';
                                        		$index++;
                    ...
                    <div class="span12">
                            ...
                            <div class="box">
                                ...
                                <div class="content">
                                    ...
                                    <form class="form-horizontal" method="post" action="processteam.php" enctype="multipart/form-data"/>
                                    <input type="hidden" name="action" id="action" value="1" />
                                    <div class="form-row row-fluid">
                                <div class="span12">
                                    <div class="row-fluid">
                                        <label class="form-label span3" for="qualification">Name:</label>
                                        <input class="span4" id="name" name="name" type="text" placeholder="Enter Name" />
                                    </div>
                                </div>
                            </div>
                            <div class="form-row row-fluid">
                                <div class="span12">
                                    <div class="row-fluid">
                                        <label class="form-label span3" for="description">Brief Description:</label>
                                        <input class="span4" id="description" name="description" type="text" placeholder="Enter Description" />
                                    </div>
                                </div>
                            </div>
                            <div class="form-row row-fluid">
                                <div class="span12">
                                    <div class="row-fluid">
                                        <label class="form-label span3" for="orderonwebsite">Order On Website:</label>
                                        <input class="span4" id="orderonwebsite" name="orderonwebsite" type="text" placeholder="Eg. 1 or 2 or 3" />
                                    </div>
                                </div>
                            </div>
                            <div class="form-row row-fluid">
                                <div class="span12">
                                    <div class="row-fluid">
                                        <label class="form-label span3" for="username">Upload Image:</label>
                                ...
                                <div class="span12">
                                    <div class="row-fluid">
                                        ...
                                        <div class="span4 controls">
                                            <button type="submit" class="btn btn-info marginR10">Add</button>
