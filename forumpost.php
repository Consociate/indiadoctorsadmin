        ...
        <div id="content" class="clearfix">
            <div class="contentwrapper"><!--Content wrapper-->
                ...
                include_once 'src/controllers/forumcontroller.php';
                	$postdetails = showForumPosts($sid,$tid);
                	$post = $postdetails[0];
                ?>
				...
				<div class="span12">
                            ...
                            <div class="box">
                                ...
                                <h4>Dated: <?php echo date('d-m-Y', strtotime($post->getDateofaddition()))?></h4>
                                    ...
                                    ?>
                                    <p>Image: </p>
                                    <p><img src="<?php echo FORUM_UPLOAD_FOLDER_PATH.$post->getImageurl()?>" width="150px"/></p>
                                    <?php 
                                    	}
                                    ?>
                                </div>
					...
					<?php 
                        ...
                        <div class="span12">
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" class="responsive forumTable display table table-bordered" width="100%">
                                ...
                                <?php 
                            include_once 'src/controllers/forumcontroller.php';
                            $postlist = showForumCommentsForPost($tid);//($sid);
                            $index = 0;
                            ...
                            <div class="box">
                                ...
                                <div class="content">
                                <form class="form-horizontal" method="post" action="processforumposts.php" />
