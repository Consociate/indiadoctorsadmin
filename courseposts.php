                ...
                <?php 
					...
					switch($role){
                        ...
                        <div class="centerContent">
                            ...
                            <ul class="bigBtnIcon">
                                <li>
                                    <a href="addcoursepost.php?sid=<?php echo $sid?>" title="Add Post" class="tipB">
					...
					<?php 
                        	if($_GET['eid']==1){
                                ...
                                <strong>Course Post Updated!.</strong> 
                            </div>
                        		<?php 
                        	}else if($_GET['eid']==2){
                        		?>
					...
					<div class="span12">
                            ...
                            $postlist = showCoursesPosts($sid);
                            $index = 0;
                            foreach($postlist as $post){
                            	echo '<tr>
                                    <td style="text-align:left;">'.($index+1).'</td>
                                    <td><a href="coursepost.php?sid='.$sid.'&tid='.$post->getPostid().'">'.$post->getPostlabel().'</a></td>
                                    <td>'.$post->getCreateby().'</td>';
                            	if($role == USER_ADMIN){
                            			echo '<td><a href="processcourseposts.php?action=3&tid='.$post->getPostid().'&st=0&sid='.$sid.'" title="Remove This" class="tip">
