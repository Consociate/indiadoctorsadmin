            ...
            <div class="contentwrapper"><!--Content wrapper-->
                ...
                <div class="heading">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <a href="userlist.php" class="tip" title="Back to User List">
                                User list
                            </a> 
                            <span class="divider">
                                <span class="icon16 icomoon-icon-arrow-right"></span>
                ...
                <div class="row-fluid">
					...
					<div class="span12">
                            ...
                            $postlist = fetchUserList();
                            $index = 0;
                            foreach($postlist as $post){
                            	$type = "";
                            	$accountstatus = "Active";
                            	switch($post->getAccounttype()){
                            		case USER_ADMIN:
                            			$type = "Admin";
                            			break;
                            		case USER_DOCTOR:
                            	...
                            	$action = '<a href="processuser.php?action=1&uid='.$post->getUserid().'&st=0" title="Remove This" class="tip">
                                    <span class="icon12 icomoon-icon-remove"></span>
                                    </a>';
                            	if(!$post->getStatus()){
                            		$accountstatus = "Inactive";
                            		$action = '<a href="processuser.php?action=1&uid='.$post->getUserid().'&st=1" title="Activate This" class="tip">
                            	...
                            	echo '<tr>
                                    ...
                                    <td><a href="userdetails.php?uid='.$post->getUserid().'">'.$post->getUsername().'</a></td>
                                    <td>'.$type.'</td>
                                    <td>'.$accountstatus.'</td>
                                    <td>'.$action.'</td>';
