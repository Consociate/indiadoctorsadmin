            ...
            <div class="contentwrapper"><!--Content wrapper-->
                ...
                <div class="heading">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <a href="classified.php" class="tip" title="back to Classified">
                                Classifieds
                            </a> 
                            <span class="divider">
                                <span class="icon16 icomoon-icon-arrow-right"></span>
                        ...
                        <li class="active">Add Classifieds</li>
                    </ul>
                ...
                <div class="row-fluid">
                            ...
                            <div class="box">
                                ...
                                <div class="title">
                                    ...
                                    <h4>
                                        <span class="icon16 iconic-icon-pin"></span>
                                        <span>Add Classifieds</span>
                                    </h4>
                                    
                                </div>
                                <div class="content">
                                   
                                    <form id="addform" class="form-horizontal" method="post" action="processclassifieds.php"  enctype="multipart/form-data" />
                                    <input type="hidden" name="action" id="action" value="1" />
                                    <p class="error_message" style="color: red;"></p>
                                    <div class="form-row row-fluid">
                                <div class="span12">
                                    <div class="row-fluid">
                                        <label class="form-label span3" for="postlabel">Classified Heading:</label>
                            ...
                            <div class="form-row row-fluid">
                                            <div class="span12">
                                                <div class="row-fluid">
                                                    <label class="form-label span3" for="textarea">Classified Details(Mention your contact details as well): </label>
                                ...
                                <div class="span12">
                                    <div class="row-fluid">
                                        <label class="form-label span3" for="username">Image:</label>
                                ...
                                <div class="span12">
                                    <div class="row-fluid">
                                        ...
                                        <div class="span4 controls">
                                            <button type="submit" class="btn btn-info marginR10">Add Classified</button>
                                            <a href="classified.php" class="btn btn-danger">Cancel</a>
                                        </div>
                                        </div>
                                    </div>
                                </div>   
