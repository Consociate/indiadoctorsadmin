                ...
                <?php 
					...
					switch($role){
                        ...
                        <div class="centerContent">
                            ...
                            <ul class="bigBtnIcon">
                                <li>
                                    <a href="addebook.php?sid=<?php echo $sid?>" title="Add Ebooks/E-Notes" class="tipB">
                                        <span class="icon brocco-icon-plus"></span>
                                        <span class="txt">Add Ebooks/E-Notes</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
                ...
                ?>
					...
					<?php 
                        	if($_GET['eid']==1){
                                ...
                                <strong>Ebooks/E-Notes Updated!.</strong> 
                            </div>
                        		<?php 
                        	}else if($_GET['eid']==2){
                        		?>
                                ...
                                <button type="button" class="close" data-dismiss="alert">&times;</button>
                                <strong>Oh snap!</strong> Error updating your Ebooks/E-Notes. Please try again later.
                            </div>
                        		<?php 
                        	}
                        ?>
					...
					<div class="span12">
                            ...
                            $postlist = showEbooksPosts($sid);
                            $index = 0;
                            foreach($postlist as $post){
                            	echo '<tr>
                                    <td style="text-align:left;">'.($index+1).'</td>
                                    <td><a href="ebookpost.php?sid='.$sid.'&tid='.$post->getPostid().'">'.$post->getPostlabel().'</a></td>
                                    <td>'.$post->getCreateby().'</td>';
                           		 if($role == USER_ADMIN){
                            			echo '<td><a href="processebooks.php?action=3&tid='.$post->getPostid().'&st=0&sid='.$sid.'" title="Remove This" class="tip">
