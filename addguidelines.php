...
?>
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <a href="guidelines.php" class="tip" title="Back to Guidelines">
                                Guidelines
                            </a> 
                            <span class="divider">
                                <span class="icon16 icomoon-icon-arrow-right"></span>
                        ...
                        <li>
                            <a href="guidelinestype.php?sid=<?php echo $sid ?>&type=<?php echo $type?>" class="tip" title="Back to <?php echo $speciality->getSpecialitylabel()?>">
						...
						?>
                        	<a href="guidelinesposts.php?sid=<?php echo $sid ?>&type=<?php echo $type?>" class="tip" title="Back to <?php echo $journaltype?>">
                                <?php echo $journaltype?>
                            </a> 
                            <span class="divider">
                                <span class="icon16 icomoon-icon-arrow-right"></span>
                            </span>
                        ...
                        <li class="active">Add Guidelines</li>
                    </ul>
                ...
                <div class="row-fluid">
                            ...
                            <div class="box">
                                ...
                                <div class="content">
                                    ...
                                    <form id="addform" class="form-horizontal" method="post" action="processguidelinespost.php"  enctype="multipart/form-data"/>
                                ...
                                <div class="span12">
                                    <div class="row-fluid">
                                        <label class="form-label span3" for="postlabel">Guidelines Heading:</label>
                            ...
                            <div class="form-row row-fluid">
                                            <div class="span12">
                                                <div class="row-fluid">
                                                    <label class="form-label span3" for="textarea">Guidelines Details: </label>
                                                    <textarea class="span8 tinymce" id="textarea" name="post" rows="10" cols="10"></textarea>
                                                </div>
                                            </div>  
                                        </div>
                                <div class="form-row row-fluid">
                                <div class="span12">
                                    <div class="row-fluid">
                                        <label class="form-label span3" for="username">Guidelines Doc(.doc/.pdf/.ppt):</label>
                                ...
                                <div class="span12">
                                    <div class="row-fluid">
                                        ...
                                        <div class="span4 controls">
                                            <button type="submit" class="btn btn-info marginR10">Add Guidelines</button>
                                            <a href="guidelinesposts.php?sid=<?php echo $sid?>&type=<?php echo $type?>" class="btn btn-danger">Cancel</a>
                                        </div>
                                        </div>
                                    </div>
                                </div>   
