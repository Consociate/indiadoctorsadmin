                ...
                <?php 
					...
					switch($role){
                        ...
                        <div class="centerContent">
                            ...
                            <ul class="bigBtnIcon">
                                <li>
                                    <a href="addhottopic.php" title="Add Hot Topic" class="tipB">
                                        <span class="icon brocco-icon-plus"></span>
                                        <span class="txt">Add Hot Topic</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
					...
					<?php 
                        	if($_GET['eid']==1){
                                ...
                                <strong>Hot Topic Updated!.</strong> 
                            </div>
                        		<?php 
                        	}else if($_GET['eid']==2){
                        		?>
                                ...
                                <button type="button" class="close" data-dismiss="alert">&times;</button>
                                <strong>Oh snap!</strong> Error updating your Hot Topic. Please try again later.
                            </div>
                        		<?php 
                        	}
                        ?>
					...
					<div class="span12">
                            ...
                            $postlist = showHottopicPosts();
                            $index = 0;
                            foreach($postlist as $post){
                            	echo '<tr>
                                    <td style="text-align:left;"><span class="icon16 iconic-icon-book-alt2"></span></td>
                                    <td><a href="hottopic.php?tid='.$post->getTid().'">'.$post->getPostlabel().'</a></td>
                                    <td>'.$post->getCreatedby().'</td>';
                                                	if($role == USER_ADMIN){
                                                		...
                                                		echo '<a href="processhottopic.php?action=3&tid='.$post->getTid().'&st=1" title="Activate This" class="tip">
                                    <span class="icon12 brocco-icon-plus"></span>
                                    </a><a href="processhottopic.php?action=3&tid='.$post->getTid().'&st=0" title="Remove This" class="tip">
