                ...
                <div class="row-fluid">
					...
					<?php 
                        	if($_GET['eid']==1){
                                ...
                                <button type="button" class="close" data-dismiss="alert">&times;</button>
                                <strong>Oh snap!</strong> Error updating tasks. Please try again later.
                            </div>
                        		<?php 
                        	}
                        ?>
                                        ...
                                        <?php 
                                        	...
                                        	foreach($todolist as $todo){
                                        		if($index%2 != 0){
                                        			...
                                        			<td>'.$todo->getTasklabel().'</td>
                                        			<td>'.date('d-m-Y', strtotime($todo->getFromdate())).' from '.$todo->getFromtime().'</td>
                                        			<td>'.date('d-m-Y', strtotime($todo->getTilldate())).' till '.$todo->getTilltime().'</td>
                                        			<td> <a href="processtodolist.php?ac=2&tid='.$todo->getTid().'" title="Remove task" class="tip"><span class="icon12 icomoon-icon-remove"></span></a></td>
                                        			</tr>';
                                        		}else{
					...
					<div class="span12">
                            ...
                            <div class="box">
                                ...
                                <div class="content">
                                    ...
                                    <form class="form-horizontal" method="post" action="processtodolist.php" />
                                    <input type="hidden" name="action" id="action" value="1" />
                                    <div class="form-row row-fluid">
                                <div class="span12">
                                    <div class="row-fluid">
                                        <label class="form-label span3" for="tasklabel">Task:</label>
                                        <input class="span4" id="tasklabel" name="tasklabel" type="text" placeholder="Enter Task name" />
                                    </div>
                                </div>
                            </div>
                            <div class="form-row row-fluid">
                                            <div class="span12">
                                                <div class="row-fluid">
                                                    <label class="form-label span4" for="checkboxes">From</label>
                                                    <div class="span2">
                                                        <input type="text" id="datepicker" name="fromdate" readonly="readonly" />
                                                    </div>
                                                </div>
                                            </div> 
                                        </div>
                                        <div class="form-row row-fluid">
                                            <div class="span12">
                                                <div class="row-fluid">
                                                    <label class="form-label span4" for="checkboxes">From Time</label>
                                                    <div class="span2">
                                                        <input id="timepicker" type="text" name="fromtime" autocomplete="off" />
                                        ...
                                        <div class="form-row row-fluid">
                                            <div class="span12">
                                                <div class="row-fluid">
                                                    <label class="form-label span4" for="checkboxes">Till</label>
                                                    <div class="span2">
                                                        <input type="text" name="tilldate" id="tilldate" readonly="readonly"/>
                                                    </div>
                                                </div>
                                            </div> 
                                        </div>
                                        <div class="form-row row-fluid">
                                            <div class="span12">
                                                <div class="row-fluid">
                                                    <label class="form-label span4" for="checkboxes">Till Time</label>
                                                    <div class="span2">
                                                        <input id="tilltime" type="text" name="tilltime" autocomplete="on" />
