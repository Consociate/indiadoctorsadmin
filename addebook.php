...
?>
                    <ul class="breadcrumb">
                        ...
                        <li class="active">Add Ebooks/E-Notes</li>
                    </ul>
                ...
                <div class="row-fluid">
                            ...
                            <div class="box">
                                ...
                                <div class="title">
                                    ...
                                    <h4>
                                        ...
                                        <span>Add Ebooks/E-Notes</span>
                                    </h4>
                                    
                                </div>
                                <div class="content">
                                   
                                    <form id="addform" class="form-horizontal" method="post" action="processebooks.php" enctype="multipart/form-data" />
                                ...
                                <div class="span12">
                                    <div class="row-fluid">
                                        <label class="form-label span3" for="postlabel">Ebooks/E-Notes Name:</label>
                            ...
                            <div class="form-row row-fluid">
                                            <div class="span12">
                                                <div class="row-fluid">
                                                    <label class="form-label span3" for="textarea">Ebooks/E-Notes Details: </label>
                                ...
                                <div class="span12">
                                    <div class="row-fluid">
                                        <label class="form-label span3" for="username">Upload Ebooks/E-Notes(PDF/Doc/PPT only):</label>
                                ...
                                <div class="span12">
                                    <div class="row-fluid">
                                        ...
                                        <div class="span4 controls">
                                            <button type="submit" class="btn btn-info marginR10">Add Ebooks/E-Notes</button>
                                            <a href="ebookposts.php?sid=<?php echo $sid?>" class="btn btn-danger">Cancel</a>
                                        </div>
                                        </div>
                                    </div>
                                </div>   
