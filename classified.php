            ...
            <div class="contentwrapper"><!--Content wrapper-->
                ...
                <div class="row-fluid">
                        ...
                        <div class="centerContent">
                            ...
                            <ul class="bigBtnIcon">
                                <li>
                                    <a href="addclassified.php" title="Add Post" class="tipB">
                                        <span class="icon brocco-icon-plus"></span>
                                        <span class="txt">Add Classified</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
					...
					<?php 
                        	if($_GET['eid']==1){
                                ...
                                <strong>Classifieds Updated! It will be listed once the Website Moderator approves it.</strong> 
                            </div>
                        		<?php 
                        	}else if($_GET['eid']==2){
                        		?>
                                ...
                                <button type="button" class="close" data-dismiss="alert">&times;</button>
                                <strong>Oh snap!</strong> Error updating classifieds. Please try again later.
                            </div>
                        		<?php 
                        	}
                        ?>
					...
					<div class="span12">
                            ...
                            $postlist = showClassifiedPosts();
                            $index = 0;
                            foreach($postlist as $post){
                            	echo '<tr>
                                    <td style="text-align:left;">'.($index+1).'</td>
                                    <td><a href="classifiedpost.php?tid='.$post->getTid().'"><span class="icon16  iconic-icon-pin"></span>'.$post->getPostlabel().'</a></td>
                                    <td>'.date('d-m-Y', strtotime($post->getDateofaddition())).'</td>
                                    <td>'.$post->getCreatedby().'</td>';
                            if($role == USER_ADMIN){
                            			echo '<td><a href="processclassifieds.php?action=3&tid='.$post->getTid().'&st=0" title="Remove This" class="tip">
