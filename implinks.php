                ...
                <?php 
					...
					switch($role){
                        ...
                        <div class="centerContent">
                            ...
                            <ul class="bigBtnIcon">
                                <li>
                                    <a href="addlinks.php" title="Add Survey" class="tipB">
                                        <span class="icon brocco-icon-plus"></span>
                                        <span class="txt">Add Links</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
					...
					<?php 
						if(isset($_GET['eid'])){
                        	if($_GET['eid']==1){
                                ...
                                <button type="button" class="close" data-dismiss="alert">&times;</button>
                                <strong>Oh snap!</strong> Error updating your links. Please try again later.
                            </div>
                        		<?php 
                        	}
						}
					...
					<div class="span12">
                            ...
                            foreach($postlist as $post){
                            	echo '<tr>
                                    ...
                                    <td><a href="implinkspost.php?tid='.$post->getTid().'">'.$post->getPostlabel().'</a></td>
                                    <td>'.$post->getCreatedby().'</td>';
                            if($role == USER_ADMIN){
                            			echo '<td><a href="processimplinks.php?action=2&tid='.$post->getTid().'&st=0" title="Remove This" class="tip">
