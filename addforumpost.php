...
?>
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <a href="forum.php" class="tip" title="Back to Forums">
                                Forums
                            </a> 
                            <span class="divider">
                                <span class="icon16 icomoon-icon-arrow-right"></span>
                        ...
                        <li>
                            <a href="forumposts.php?sid=<?php echo $sid?>" class="tip" title="Back to <?php echo $speciality->getSpecialitylabel()?>">
                        ...
                        <li class="active">Add Forum Post</li>
                    </ul>
                ...
                <div class="row-fluid">
                            ...
                            <div class="box">
                                ...
                                <div class="content">
                                    ...
                                    <form id="addform" class="form-horizontal" method="post" action="processforumposts.php"  enctype="multipart/form-data" />
                                ...
                                <div class="span12">
                                    <div class="row-fluid">
                                        ...
                                        <div class="span4 controls">
                                            <button type="submit" class="btn btn-info marginR10">Add Post</button>
                                            <a href="forumposts.php?sid=<?php echo $sid?>" class="btn btn-danger">Cancel</a>
                                        </div>
                                        </div>
                                    </div>
                                </div>   
