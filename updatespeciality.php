            ...
            <div class="contentwrapper"><!--Content wrapper-->
                ...
                <div class="heading">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <a href="speciality.php" class="tip" title="Back to Specialities">
                                Specialities
                            </a> 
                            <span class="divider">
                                <span class="icon16 icomoon-icon-arrow-right"></span>
                        ...
                        <li class="active">Update Speciality</li>
                    </ul>
                            ...
                            <div class="box">
                                ...
                                <div class="content">
                                   <?php 
                                   	...
                                   	$specialitylist = getSpecialityMasterListForAdmin($_GET['tid']);
                                   	$speciality = $specialitylist[0];
                                   ?>
                                    <form class="form-horizontal" method="post" action="processspeciality.php" />
                                ...
                                <div class="span12">
                                    <div class="row-fluid">
                                        <label class="form-label span3" for="postlabel">Speciality Label:</label>
                                ...
                                <div class="span12">
                                    <div class="row-fluid">
                                        ...
                                        <div class="span4 controls">
                                            <button type="submit" class="btn btn-info marginR10">Update Speciality</button>
