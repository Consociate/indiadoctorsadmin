                ...
                <div class="row-fluid">
					...
					<div class="span12">
                            ...
                            foreach($specialitylist as $speciality){
                            	$nationalcount = showCountOfJournalNationalPosts($speciality->getSpecialityid());
                                	$intercount = showCountOfJournalInterNationalPosts($speciality->getSpecialityid()); 
                            	echo '<tr>
                                    <td style="text-align:left;">'.($index+1).'</td>
                                    <td><a href="journaltype.php?sid='.$speciality->getSpecialityid().'">'.$speciality->getSpecialitylabel().'</a></td>
