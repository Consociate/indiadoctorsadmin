            ...
            <div class="contentwrapper"><!--Content wrapper-->
                ...
                <div class="heading">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <a href="examques.php" class="tip" title="Back to University Exam Question Papers">
                ...
                include_once 'src/controllers/previousquestioncontroller.php';
                	$postdetails = showPreviousQuestionPosts($sid,$tid);
                	$post = $postdetails[0];
                ?>
				...
				<div class="span12">
                            ...
                            <div class="box">
                                ...
                                <h4>Dated: <?php echo date('d-m-Y', strtotime($post->getDateofaddition()))?></h4>
                                    ...
                                    ?>
                                    <p>Download Link: 
                                    <a href="<?php echo LIBRARY_EXAMQUESTIONPAPER_UPLOAD_FOLDER_PATH.$post->getImageurl()?>" target="_blank"> Click here</a></p>
                                    <?php 
                                    	}
                                    ?>
                                </div>
