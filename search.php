        ...
        <div id="content" class="clearfix">
            <div class="contentwrapper"><!--Content wrapper-->
                ...
                <div class="heading">
                    ...
                    <h3>Search For "<?php echo $searchquery?>"</h3>                    
                ...
                <div class="row-fluid">
					...
					<div class="span12">
                            <div class="page-header">
                                <h4>You searched for "<?php echo $searchquery?>"</h4>
                            </div>
                            ...
                            foreach($data as $ent){
                            	echo '<tr>
                                    <td><a href="viewuserprofile.php?uid='.$ent->getUserid().'">'.$ent->getName().'('.$ent->getUsername().')</a></td>';
                                  echo '</tr>';
                            }
                            ?>
                                </tbody>
