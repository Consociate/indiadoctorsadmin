            ...
            <div class="contentwrapper"><!--Content wrapper-->
                ...
                ?>
                        ...
                        <div class="centerContent">
                            ...
                            <ul class="bigBtnIcon">
                                <li>
                                    <a href="addsurvey.php" title="Add Survey" class="tipB">
                                        <span class="icon brocco-icon-plus"></span>
                                        <span class="txt">Add Survey</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
					...
					<?php 
                        	if($_GET['eid']==1){
                                ...
                                <button type="button" class="close" data-dismiss="alert">&times;</button>
                                <strong>Oh snap!</strong> Error updating your survey. Please try again later.
                            </div>
                        		<?php 
                        	}
                        ?>
					...
					<div class="span12">
                            ...
                            $postlist = showSuvreyPosts();
                            $index = 0;
                            foreach($postlist as $post){
                            	echo '<tr>
                                    <td style="text-align:left;">'.($index+1).'</td>
                                    <td><a href="surveypost.php?tid='.$post->getTid().'">'.$post->getPostlabel().'</a></td>
                                    <td>'.$post->getCreatedby().'</td>';
                            	if($role == USER_ADMIN){
                            			echo '<td><a href="processsurveypost.php?action=3&tid='.$post->getTid().'&st=0" title="Remove This" class="tip">
