...
$(document).ready(function() {
    ...
    $("#searchquery").autocomplete({ 
			source: function( request, response ) {
				$.getJSON( "ajascript.php?query="+request.term,  response ); 
			},
			minLength: 2,
...
*/
	...
	$('#tilltime').timeEntry('setTime', '22:15')
    ...
    $("#form-validate").validate({
		...
		messages: {
			...
			username:{
				...
				minlength: "Username should be atleast 5 characters long",
	...
	if($('table').hasClass('forumCommentTable')){
		$('.forumTable').dataTable({
			"sPaginationType": "full_numbers",
			"bJQueryUI": false,
			"bAutoWidth": false,
