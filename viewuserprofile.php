                ...
                <div class="row-fluid">
                    <div class="span12">
                        ...
                        <div class="page-header">
                            ...
                            <?php 
                        	if(fetchShareSettingForUserForOnePermission($uid, SHARE_PROFILE)==1){
                        ?>
                            ...
                            <?php 
                        		...
                        		echo '<p>User has not shared profile information with public</p>';
                        	}
                            ?>
                            <?php 
                            	switch($master->getAccounttype()){
                            		...
                            		case USER_DOCTOR:
                            			?>
                            			<?php 
                            				if(fetchShareSettingForUserForOnePermission($uid, SHARE_CV)==1){
                            			?>
                            			<div class="title">
								<h4>
                        		...
                        		echo '<p>User has not shared CV information with public</p>';
                        	}
                                ?>
                                <div class="title"> 
                                    <h4>
                                ...
                                <?php 
                                	if(fetchShareSettingForUserForOnePermission($uid, SHARE_EDU)==1){
                                ?>
                                <div class="content noPad">
                                ...
                                <?php 
                                		...
                                		echo '<p>User has not shared Qualifications information with public</p>';
                                	}
                                ?>
                                ...
                                <?php 
                                	if(fetchShareSettingForUserForOnePermission($uid, SHARE_SPEC)==1){
                                ?>
                                <div class="content noPad">
                                    <table class="responsive table table-bordered">
                                        <thead>
                                ...
                                <?php 
                                	...
                                	echo '<p>User has not shared Specializations information with public</p>';
                                	}
                                ?>
                                <div class="title">
                                ...
                                <?php 
                                	if(fetchShareSettingForUserForOnePermission($uid, SHARE_WORK)==1){
                                ?>
                                <div class="content noPad">
                                    <table class="responsive table table-bordered">
                                        <thead>
                                ...
                                <?php 
                                	...
                                	echo '<p>User has not shared Work-related information with public</p>';
                                	}
                                ?>
                            			<?php 
                            			break;
