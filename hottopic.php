...
<?php include_once 'ui/search.php';?>
                ...
                include_once 'src/controllers/hottopiccontroller.php';
                	$postdetails = showHottopicPosts($tid);
                	$post = $postdetails[0];
                ?>
				...
				<div class="span12">
                            ...
                            <div class="box">
                                ...
                                <h4>Dated: <?php echo date('d-m-Y', strtotime($post->getDateofaddition()))?></h4>
                                    ...
                                    <p><?php 
                                    	if($post->getPathurl() != NULL ){
                                    		if(strlen($post->getPathurl() > 1)){
                                    			echo '<a href="'.HOTTOPIC_UPLOAD_FOLDER_PATH. $post->getPathurl().'" target="_blank">View Here</a>';
                                    		}
                                    	}
                                    ?></p>
                                </div>
					...
					<?php 
                        ...
                        <div class="span12">
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" class="responsive forumTable display table table-bordered" width="100%">
                                        ...
                                        <tbody>
                                <?php 
                            $postlist = showHottopicCommentsForPost($tid);//($sid);
                            $index = 0;
                            ...
                            <div class="box">
                                ...
                                <div class="content">
                                <form class="form-horizontal" method="post" action="processhottopic.php" />
