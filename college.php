            ...
            <div class="contentwrapper"><!--Content wrapper-->
                ...
                <div class="heading">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="active">Colleges/Universities</li>
                    </ul>
                ...
                <div class="row-fluid">
                        ...
                        <div class="centerContent">
                            ...
                            <ul class="bigBtnIcon">
                                <li>
                                    <a href="addcollege.php" title="Add College/University" class="tipB">
                                        <span class="icon brocco-icon-plus"></span>
                                        <span class="txt">Add Institutes</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
					...
					<?php 
                        	if($_GET['eid']==1){
                                ...
                                <strong>Colleges/Universities Updated!</strong> 
                            </div>
                        		<?php 
                        	}else if($_GET['eid']==2){
                        		?>
                                ...
                                <button type="button" class="close" data-dismiss="alert">&times;</button>
                                <strong>Oh snap!</strong> Error updating Colleges/Universities. Please try again later.
                            </div>
                        		<?php 
                        	}
                        ?>
                ...
                <div class="row-fluid">
					...
					<div class="span12">
                            <div class="page-header">
                                <h4>Colleges/Universities List</h4>
                            </div>
                            ...
                            $collegelist = getCollegeMasterListForAdmin();
                            $index = 0;
                            foreach($collegelist as $college){
                            	$statusmessage ="";
                            	$actionmessage = "";
                            	switch($college->getStatus()){
                            		case 1:
                            			$statusmessage ="Active";
                            			$actionmessage = '<a href="processcollege.php?action=3&tid='.$college->getSpecialityid().'" title="Edit This" class="tip">
                                    <span class="icon12 icomoon-icon-pencil"></span>
                                    </a>
                                    <a href="processcollege.php?action=2&tid='.$college->getSpecialityid().'&st=2" title="Remove This" class="tip">
                                    ...
                                    <a href="processcollege.php?action=2&tid='.$college->getSpecialityid().'&st=1" title="Activate This" class="tip">
                            	...
                            	echo '<tr>
                                    ...
                                    <td>'.$college->getSpecialitylabel().'</td>
                                    <td>'.$statusmessage.'</td>
                                    <td>
                                    '.$actionmessage.'
                                    </td>
