            ...
            <div class="contentwrapper"><!--Content wrapper-->
                ...
                <div class="heading">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="active">International News</li>
                    </ul>
                ...
                ?>
                        ...
                        <div class="centerContent">
                            ...
                            <ul class="bigBtnIcon">
                                <li>
                                    <a href="addinternationalnews.php" title="Add Post" class="tipB">
                                        <span class="icon brocco-icon-plus"></span>
                                        <span class="txt">Add News</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
					...
					<?php 
                        	if($_GET['eid']==1){
                                ...
                                <button type="button" class="close" data-dismiss="alert">&times;</button>
                                <strong>Oh snap!</strong> Error updating news. Please try again later.
                            </div>
                        		<?php 
                        	}
                        ?>
					...
					<div class="span12">
                            ...
                            $postlist = showInterNationalNews();
                            $index = 0;
                            foreach($postlist as $post){
                            	echo '<tr>
                                    <td style="text-align:left;">'.($index+1).'</td>
                                    <td><a href="internationalnewspost.php?tid='.$post->getTid().'">'.$post->getPostlabel().'</a></td>
                                    <td>'.date('d-m-Y', strtotime($post->getDateofaddition())).'</td>
                                    <td>'.$post->getCreatedby().'</td>';
                            	if($role == USER_ADMIN){
                            			echo '<td><a href="processinternationalnews.php?action=3&tid='.$post->getTid().'&st=0" title="Remove This" class="tip">
