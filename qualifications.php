                ...
                <div class="row-fluid">
					...
					<?php 
                        	if($_GET['eid']==1){
                                ...
                                <strong>Qualifications Updated!</strong> 
                            </div>
                        		<?php 
                        	}else if($_GET['eid']==2){
                        		?>
                                ...
                                <button type="button" class="close" data-dismiss="alert">&times;</button>
                                <strong>Oh snap!</strong> Error updating qualifications. Please try again later.
                            </div>
                        		<?php 
                        	}
                        ?>
                            ...
                            <div class="box">
                                ...
                                <div class="title">
                                    ...
                                    <h4>
                                        ...
                                        <span>Existing Qualifications</span>
                                    </h4>
                                        		...
                                        		echo '<tr>
		                                            ...
		                                            <td>
		                                                <div class="controls center">
		                                                    <a href="deleteotherprofile.php?ac=2&tid='.$qual->getTid().'" title="Remove This" class="tip"><span class="icon12 icomoon-icon-remove"></span></a>
		                                                </div>
		                                            </td>
		                                          </tr>';
                                        		$index++;
                    ...
                    <div class="span12">
                            ...
                            <div class="box">
                                ...
                                <div class="span12">
                                    <div class="row-fluid">
                                        <label class="form-label span3" for="qualification">Qualification:</label>
                                        <input class="span4" id="qualification" name="qualification" type="text" placeholder="Enter Degree Name" />
                                    </div>
                                </div>
                            </div>
                            <div class="form-row row-fluid">
                                            <div class="span12">
                                                <div class="row-fluid">
                                                    <label class="form-label span4" for="checkboxes">Year of Passing</label>
                                                    <div class="span8 controls">   
                                                        <select name="qyear" id="qyear">
                                                        <?php 
                                                        	$curryear = date('Y');
                                                        	$endyear = $curryear+10;
