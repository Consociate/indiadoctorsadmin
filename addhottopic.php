            ...
            <div class="contentwrapper"><!--Content wrapper-->
                ...
                <div class="heading">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <a href="hottopics.php" class="tip" title="Back to Hot Topic">
                               Hot Topic
                            </a> 
                            <span class="divider">
                                <span class="icon16 icomoon-icon-arrow-right"></span>
                        ...
                        <li class="active">Add Hot Topic</li>
                    </ul>
                            ...
                            <div class="box">
                                ...
                                <div class="title">
                                    ...
                                    <h4>
                                        ...
                                        <span>Add Hot Topic</span>
                                    </h4>
                                    
                                </div>
                                <div class="content">
                                   
                                    <form id="addform" class="form-horizontal" method="post" action="processhottopic.php"  enctype="multipart/form-data" />
                                ...
                                <div class="span12">
                                    <div class="row-fluid">
                                        ...
                                        <div class="span4 controls">
                                            <button type="submit" class="btn btn-info marginR10">Add Hot Topic</button>
                                            <a href="hottopics.php" class="btn btn-danger">Cancel</a>
                                        </div>
                                        </div>
                                    </div>
                                </div>   
