            ...
            <div class="contentwrapper"><!--Content wrapper-->
                ...
                <div class="heading">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <a href="classified.php" class="tip" title="Back to Classifieds">
                                Classifieds
                            </a> 
                            <span class="divider">
                                <span class="icon16 icomoon-icon-arrow-right"></span>
                ...
                include_once 'src/controllers/classifiedcontroller.php';
                	$tid = $_GET['tid'];
                	$postdetails = showClassifiedPosts($tid);
                	$post = $postdetails[0];
                ?>
				...
				<div class="span12">
                            ...
                            <div class="box">
                                ...
                                <h4>Dated: <?php echo date('d-m-Y', strtotime($post->getDateofaddition()))?></h4>
                                    ...
                                    <p><?php if($post->getImageurl()!= NULL){
                                    	echo 'IMAGE: <img src="'.CLASSIFIED_UPLOAD_FOLDER_PATH.$post->getImageurl().'" width="150px" />';
                                    }?></p>
                                </div>
					...
					<?php 
                        ...
                        <div class="span12">
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" class="responsive forumTable display table table-bordered" width="100%">
                                        ...
                                        <tbody>
                                <?php 
                            $postlist = showClassifiedCommentsForPost($tid);//($sid);
                            $index = 0;
                            ...
                            <div class="box">
                                ...
                                <div class="content">
                                <form class="form-horizontal" method="post" action="processclassifieds.php" />
