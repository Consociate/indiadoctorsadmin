                    ...
                    <div class="span12">
                            ...
                            <table class="responsive table">
                                <tbody>
                                  ...
                                  <tr>
                                    ...
                                    <td><?php 
	                                    	if(strlen($user->getProfileimageurlpath())>2){
	                                    		?>
	                                    		<img src="<?php echo PROFILE_IMG_UPLOAD_FOLDER_PATH.$user->getProfileimageurlpath()?>" style="max-height: 60px; max-width: 60px;" alt="" class="image marginR10" />
                                  ...
                                  <tr>
                                    ...
                                    <td><?php echo $user->getMobileno()?></td>
                                  </tr>
                                  <tr>
                                    <td>Gender</td>
                                    <td><?php 
						...
						<div class="title">
                                ...
                                <div class="content noPad">
                                   <p><?php 
                                   	if(getCVPathForUser($_SESSION['uid'])!= NULL){
                                   	 	echo '<a href="'.PROFILE_CV_UPLOAD_FOLDER_PATH.getCVPathForUser($_SESSION['uid']).'" target="_blank">See CV here</a>';
                                   	 	?>
                                   	 	<form class="form-horizontal seperator" enctype="multipart/form-data" method="post" action="processupdatecv.php"/>
                            <div class="form-row row-fluid">
                                <div class="span12">
                                    <div class="row-fluid">
                                        <label class="form-label span3" for="username">CV(pdf or microsoft word):</label>
                                ...
                                <div class="span12">
                                    <div class="row-fluid">
                                        ...
                                        <div class="span4 controls">
                                            <button type="submit" class="btn btn-info marginR10">Update CV</button>
                                        </div>
                                        </div>
                                    </div>
                                </div>   
                            ...
                            <div class="form-row row-fluid">        
                                <div class="span12">
                                    <div class="row-fluid">
                                        ...
                                        <div class="span3"></div>
                                        <div class="span4 controls">
                                            <button type="submit" class="btn btn-info marginR10">Upload CV</button>
                                        </div>
                                        </div>
                                    </div>
                                </div>   
