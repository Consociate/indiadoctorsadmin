            ...
            <div class="contentwrapper"><!--Content wrapper-->
						...
						$journaltype="";
							switch($type){
								case 1:
									...
									$postlist = showGuidelinesNationalPosts($sid);
									break;
								case 2:
									$journaltype= 'INTERNATIONAL';
									$postlist = showGuidelinesInterNationalPosts($sid);
									break;
							}
							echo $journaltype;
						?>
                ...
                <div class="row-fluid">
                        ...
                        <div class="centerContent">
                            ...
                            <ul class="bigBtnIcon">
                                <li>
                                    <a href="addguidelines.php?sid=<?php echo $sid?>&type=<?php echo $type?>" title="Add Guidelines" class="tipB">
                                        <span class="icon brocco-icon-plus"></span>
                                        <span class="txt">Add Guidelines</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
					...
					<?php 
                        	if($_GET['eid']==1){
                                ...
                                <strong>Guidelines Updated!.</strong> 
                            </div>
                        		<?php 
                        	}else if($_GET['eid']==2){
                        		?>
                                ...
                                <button type="button" class="close" data-dismiss="alert">&times;</button>
                                <strong>Oh snap!</strong> Error updating Guidelines. Please try again later.
                            </div>
                        		<?php 
                        	}
                        ?>
					...
					<div class="span12">
                            <div class="page-header">
                                <h4><?php echo $speciality->getSpecialitylabel()?> (<?php echo $journaltype?>)</h4>
                            </div>
                            ...
                            foreach($postlist as $post){
                            	echo '<tr>
                                    ...
                                    <td><a href="guidelinespost.php?sid='.$sid.'&tid='.$post->getPostid().'&type='.$type.'">'.$post->getPostlabel().'</a></td>
                                    <td>'.$post->getCreateby().'</td>';
                            	if($role == USER_ADMIN){
                            			echo '<td><a href="processguidelinespost.php?action=3&tid='.$post->getPostid().'&st=0&sid='.$sid.'&type='.$type.'" title="Remove This" class="tip">
