                ...
                <?php 
					...
					switch($role){
                        ...
                        <div class="centerContent">
                            ...
                            <ul class="bigBtnIcon">
                                <li>
                                    <a href="addjobpost.php" title="Add Post" class="tipB">
					...
					<?php 
                        	if($_GET['eid']==1){
                                ...
                                <strong>Job Openings Updated!</strong> 
                            </div>
                        		<?php 
                        	}else if($_GET['eid']==2){
                        		?>
					...
					<div class="span12">
                            ...
                            $postlist = showJobPosts();
                            $index = 0;
                            foreach($postlist as $post){
                            	echo '<tr>
                                    <td style="text-align:left;"><span class="icon16 iconic-icon-calendar"></span></td>
                                    <td><a href="jobpost.php?tid='.$post->getTid().'">'.$post->getPostlabel().'</a></td>
                                    <td>'.$post->getCreatedby().'</td>';
                            if($role == USER_ADMIN){
                            			echo '<td><a href="processjobposts.php?action=3&tid='.$post->getTid().'&st=0" title="Remove This" class="tip">
