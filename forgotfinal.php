                    ...
                    <div class="span12">
                        ...
                        <?php 
                        	if($_GET['eid']==1){
                                ...
                                <strong>Your new password has been mailed to your email address. Kindly use this new password to login into your account. We suggest you to change the password once you login.</strong> 
                                ...
                                <button type="button" class="close" data-dismiss="alert">&times;</button>
                                <strong>Oh snap!</strong> Invalid username entered. Please try again <a href="forgotpassword.php">Generate New Password</a>.
                            </div>
                        		<?php 
                        	}
                        ?>
