            ...
            <div class="contentwrapper"><!--Content wrapper-->
                ...
                <div class="heading">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="active">MD/MS Exams</li>
                    </ul>
					...
					<div class="span12">
                            ...
                            foreach($specialitylist as $speciality){
                            	echo '<tr>
                                    ...
                                    <td><a href="mdposts.php?sid='.$speciality->getSpecialityid().'">'.$speciality->getSpecialitylabel().'</a></td>
                                    <td>'.showCountOfMDExamPosts($speciality->getSpecialityid()).'</td>
                                  </tr>';
                            	$index++;
                            }
                            ?>
