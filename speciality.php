            ...
            <div class="contentwrapper"><!--Content wrapper-->
                ...
                <div class="row-fluid">
                        ...
                        <div class="centerContent">
                            ...
                            <ul class="bigBtnIcon">
                                <li>
                                    <a href="addspeciality.php" title="Add Speciality" class="tipB">
                                        <span class="icon brocco-icon-plus"></span>
                                        <span class="txt">Add Speciality</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
					...
					<?php 
                        	if($_GET['eid']==1){
                                ...
                                <strong>Speciality Updated!</strong> 
                            </div>
                        		<?php 
                        	}else if($_GET['eid']==2){
                        		?>
                                ...
                                <button type="button" class="close" data-dismiss="alert">&times;</button>
                                <strong>Oh snap!</strong> Error updating your speciality. Please try again later.
                            </div>
                        		<?php 
                        	}
                        ?>
                ...
                <div class="row-fluid">
					...
					<div class="span12">
                            ...
                            $specialitylist = getSpecialityMasterListForAdmin();
                            $index = 0;
                            foreach($specialitylist as $speciality){
                            	$statusmessage ="";
                            	$actionmessage = "";
                            	switch($speciality->getStatus()){
                            		case 1:
                            			$statusmessage ="Active";
                            			$actionmessage = '<a href="processspeciality.php?action=3&tid='.$speciality->getSpecialityid().'" title="Edit This" class="tip">
                                    <span class="icon12 icomoon-icon-pencil"></span>
                                    </a>
                                    <a href="processspeciality.php?action=2&tid='.$speciality->getSpecialityid().'&st=2" title="Remove This" class="tip">
                                    ...
                                    <a href="processspeciality.php?action=2&tid='.$speciality->getSpecialityid().'&st=1" title="Activate This" class="tip">
                            	...
                            	echo '<tr>
                                    ...
                                    <td>'.$speciality->getSpecialitylabel().'</td>
                                    <td>'.$statusmessage.'</td>
                                    <td>
                                    '.$actionmessage.'
                                    </td>
