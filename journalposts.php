            ...
            <div class="contentwrapper"><!--Content wrapper-->
						...
						$journaltype="";
							switch($type){
								case 1:
									...
									$postlist = showJournalNationalPosts($sid);
									break;
								case 2:
									$journaltype= 'INTERNATIONAL';
									$postlist = showJournalInterNationalPosts($sid);
									break;
							}
							echo $journaltype;
						?>
                ...
                <div class="row-fluid">
                        ...
                        <div class="centerContent">
                            ...
                            <ul class="bigBtnIcon">
                                <li>
                                    <a href="addjournalpost.php?sid=<?php echo $sid?>&type=<?php echo $type?>" title="Add Post" class="tipB">
                                        <span class="icon brocco-icon-plus"></span>
                                        <span class="txt">Add Journal</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
					...
					<?php 
                        	if($_GET['eid']==1){
                                ...
                                <strong>Journals Updated!.</strong> 
                            </div>
                        		<?php 
                        	}else if($_GET['eid']==2){
                        		?>
                                ...
                                <button type="button" class="close" data-dismiss="alert">&times;</button>
                                <strong>Oh snap!</strong> Error updating Journals. Please try again later.
                            </div>
                        		<?php 
                        	}
                        ?>
					...
					<div class="span12">
                            ...
                            foreach($postlist as $post){
                            	echo '<tr>
                                    ...
                                    <td><a href="journalpost.php?sid='.$sid.'&tid='.$post->getPostid().'&type='.$type.'">'.$post->getPostlabel().'</a></td>
                                    <td>'.$post->getCreateby().'</td>';
                            if($role == USER_ADMIN){
                            			echo '<td><a href="processjournalpost.php?action=3&tid='.$post->getPostid().'&st=0&sid='.$sid.'&type='.$type.'" title="Remove This" class="tip">
