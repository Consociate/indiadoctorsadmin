            ...
            <div class="contentwrapper"><!--Content wrapper-->
                ...
                <div class="heading">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <a href="college.php" class="tip" title="Back to Colleges/Universities">
                        ...
                        <li class="active">Update Colleges/Universities</li>
                    </ul>
                            ...
                            <div class="box">
                                ...
                                <div class="title">
                                    ...
                                    <h4>
                                        ...
                                        <span>Update Colleges/Universities</span>
                                    </h4>
                                ...
                                <div class="content">
                                   <?php 
                                   	...
                                   	$specialitylist = getCollegeMasterListForAdmin($_GET['tid']);
                                   	$speciality = $specialitylist[0];
                                   ?>
                                    <form class="form-horizontal" method="post" action="processcollege.php" />
                                    <input type="hidden" name="action" id="action" value="4" />
                                    <input type="hidden" name="sid" id="sid" value="<?php echo $speciality->getSpecialityid()?>" />
                                    <div class="form-row row-fluid">
                                <div class="span12">
                                    <div class="row-fluid">
                                        <label class="form-label span3" for="postlabel">Institute Name:</label>
                                        <input class="span4" id="postlabel" maxlength="100" name="postlabel" value="<?php echo $speciality->getSpecialitylabel()?>" type="text" placeholder="Enter heading" />
                                    </div>
                                </div>
                            </div>
                               <div class="form-row row-fluid">        
                                <div class="span12">
                                    <div class="row-fluid">
                                        ...
                                        <div class="span4 controls">
                                            <button type="submit" class="btn btn-info marginR10">Update Colleges/Universities</button>
                                            <a href="college.php" class="btn btn-danger">Cancel</a>
                                        </div>
                                        </div>
                                    </div>
                                </div>   
