            ...
            <div class="contentwrapper"><!--Content wrapper-->
                ...
                <div class="heading">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <a href="mdexam.php" class="tip" title="Back to MD/MS Exams">
                                MD/MS Exams
                            </a> 
                            <span class="divider">
                                <span class="icon16 icomoon-icon-arrow-right"></span>
                ...
                <div class="row-fluid">
                        ...
                        <div class="centerContent">
                            ...
                            <ul class="bigBtnIcon">
                                <li>
                                    <a href="addmdpost.php?sid=<?php echo $sid?>" title="Add Post" class="tipB">
                                        <span class="icon brocco-icon-plus"></span>
                                        <span class="txt">Add Question</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
					...
					<div class="span12">
                            ...
                            $postlist = showMDExamPosts($sid);
                            $index = 0;
                            foreach($postlist as $post){
                            	echo '<tr>
                                    <td style="text-align:left;">'.($index+1).'</td>
                                    <td><a href="mdpost.php?sid='.$sid.'&tid='.$post->getPostid().'">'.$post->getPostlabel().'</a></td>
                                    <td>'.$post->getCreateby().'</td>';
                            if($role == USER_ADMIN){
                            			echo '<td><a href="processmdexamposts.php?action=3&tid='.$post->getPostid().'&st=0&sid='.$sid.'" title="Remove This" class="tip">
