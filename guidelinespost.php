						...
						$journaltype="";
							switch($type){
								case 1:
									...
									$postdetails = showGuidelinesNationalPosts($sid, $tid);
									break;
								case 2:
									$journaltype= 'INTERNATIONAL';
									$postdetails = showGuidelinesInterNationalPosts($sid, $tid);
									break;
							}
						?>
				...
				<div class="span12">
                            ...
                            <div class="box">
                                ...
                                <h4>Dated: <?php echo date('d-m-Y', strtotime($post->getDateofaddition()))?></h4>
                                    ...
                                    <?php 
                                    if(strlen($post->getPathurl())>2){
                                    	?>
                                    	<p>See <a href="<?php echo LIBRARY_GUIDELINES_UPLOAD_FOLDER_PATH.$post->getPathurl()?>" target="_blank">here</a></p>
                                    	<?php 
                                    }
                                    ?>
                                </div>
