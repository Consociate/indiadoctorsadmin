        ...
        <div id="content" class="clearfix">
            <div class="contentwrapper"><!--Content wrapper-->
                ...
                include_once 'src/controllers/examcontroller.php';
                	$postdetails = showQuizPosts($sid,$tid);
                	$post = $postdetails[0];
                ?>
				...
				<div class="span12">
                            ...
                            <div class="box">
                                ...
                                <h4>Dated: <?php echo date('d-m-Y', strtotime($post->getDateofaddition()))?></h4>
                                    ...
                                    <p>Option 1: <?php echo $post->getOption1()?></p>
                                    <p>Option 2: <?php echo $post->getOption2()?></p>
                                    <p>Option 3: <?php echo $post->getOption3()?></p>
                                    <p>Option 4: <?php echo $post->getOption4()?></p>
                                    <p><a href="#" id="show-correct-answer" class="btn btn-info marginR10">Show Correct Answer</a> <div id="correct-answer">Correct Answer is: Option <?php echo $post->getCorrectanswer()?> <br /><?php echo $post->getExplanation()?></div></p>
                                </div>
