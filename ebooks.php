            ...
            <div class="contentwrapper"><!--Content wrapper-->
                ...
                <div class="heading">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="active">Ebooks/E-Notes</li>
                    </ul>
					...
					<div class="span12">
                            ...
                            foreach($specialitylist as $speciality){
                            	echo '<tr>
                                    ...
                                    <td><a href="ebookposts.php?sid='.$speciality->getSpecialityid().'">'.$speciality->getSpecialitylabel().'</a></td>
                                    <td>'.showCountOfEbooksPosts($speciality->getSpecialityid()).'</td>
                                  </tr>';
                            	$index++;
                            }
                            ?>
