					...
					<div class="span12">
                            ...
                            foreach($specialitylist as $speciality){
                            	echo '<tr>
                                    ...
                                    <td><a href="conferenceposts.php?sid='.$speciality->getSpecialityid().'">'.$speciality->getSpecialitylabel().'</a></td>
                                    <td>'.showCountOfConferencesPosts($speciality->getSpecialityid()).'</td>
                                  </tr>';
                            	$index++;
                            }
                            ?>
