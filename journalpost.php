						...
						$journaltype="";
							switch($type){
								case 1:
									...
									$postdetails = showJournalNationalPosts($sid, $tid);
									break;
								case 2:
									$journaltype= 'INTERNATIONAL';
									$postdetails = showJournalInterNationalPosts($sid, $tid);
									break;
							}
						?>
				...
				<div class="span12">
                            ...
                            <div class="box">
                                ...
                                <h4>Dated: <?php echo date('d-m-Y', strtotime($post->getDateofaddition()))?></h4>
                                    ...
                                    <p><?php if($post->getPathurl() != NULL){
                                    	echo 'Document: <a href="'.LIBRARY_JOURNAL_UPLOAD_FOLDER_PATH.$post->getPathurl().'" target="_blank" />View Details</a>';
                                    }?></p>
                                </div>
