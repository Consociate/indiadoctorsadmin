            ...
            <div class="contentwrapper"><!--Content wrapper-->
                ...
                <div class="heading">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="active">University Exam Question Papers</li>
                    </ul>
                ...
                <div class="row-fluid">
					...
					<div class="span12">
                            ...
                            $specialitylist = getCollegeMasterList();
                            $index = 0;
                            foreach($specialitylist as $speciality){
                            	echo '<tr>
                                    <td style="text-align:left;">'.($index+1).'</td>
                                    <td><a href="examquesposts.php?sid='.$speciality->getSpecialityid().'">'.$speciality->getSpecialitylabel().'</a></td>
                                    <td>'.showNumberOfPreviousQuestionPerCollege($speciality->getSpecialityid()).'</td>
                                  </tr>';
                            	$index++;
                            }
                            ?>
