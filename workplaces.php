                                        		...
                                        		echo '<tr>
		                                            ...
		                                            <td>
		                                                <div class="controls center">
		                                                    <a href="deleteotherprofile.php?ac=3&tid='.$work->getTid().'" title="Remove This" class="tip"><span class="icon12 icomoon-icon-remove"></span></a>
		                                                </div>
		                                            </td>
		                                          </tr>';
                                        		$index++;
                    ...
                    <div class="span12">
                            ...
                            <div class="box">
                                ...
                                <div class="content">
                                    ...
                                    <form class="form-horizontal" method="post" action="processotherprofile.php" />
                                         <input type="hidden" name="action" id="action" value="3" />
                                    <div class="form-row row-fluid">
                                <div class="span12">
                                    <div class="row-fluid">
                                        <label class="form-label span3" for="org">Organization:</label>
                                        <input class="span4" id="org" name="org" type="text" placeholder="Enter Organization/Hospital Name" />
                                    </div>
                                </div>
                            </div>
                                        <div class="form-row row-fluid">
