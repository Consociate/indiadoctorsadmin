                    ...
                    <div class="span12">
                        ...
                        <?php 
                        	if($_GET['eid']==1){
                                ...
                                <strong>Thanking you!</strong> You successfully registered with IndiaDoctors.org with email <?php echo $_GET['el']?>.
                               An Email Verification link has been sent to your email address <?php echo $_GET['el']?>. Please check your Inbox or Spam Folder or Junk Mail Folder. Click on the link to activate your account. 
                                 You can login using the username: <?php echo $_GET['un']?> and the password that you mentioned at the time of registration. <a href="index.php">Login</a>
                            </div>
                        		<?php 
                        	}else{
                        		?>
                                ...
                                <button type="button" class="close" data-dismiss="alert">&times;</button>
                                <strong>Oh snap!</strong> Error submitting the details. Please try again later.
                            </div>
                        		<?php 
                        	}
                        ?>
