                ...
                <div class="row-fluid">
					...
					<?php 
                        	if($_GET['eid']==1){
                                ...
                                <button type="button" class="close" data-dismiss="alert">&times;</button>
                                <strong>Oh snap!</strong> Error updating profile. Please try again later.
                            </div>
                        		<?php 
                        	}
                        ?>
                    ...
                    <div class="span12">
                        ...
                        <form class="form-horizontal seperator" enctype="multipart/form-data" method="post" action="processeditprofile.php"/>
                            <div class="form-row row-fluid">
                                <div class="span12">
                                    <div class="row-fluid">
                                        <label class="form-label span3" for="username">Username:</label>
                                        <input class="span4" id="username" type="text" disabled="disabled" value="<?php echo $_SESSION['un']?>" />
                                    ...
                                    <div class="row-fluid">
                                        ...
                                        <?php 
	                                    	if(strlen($user->getProfileimageurlpath())>2){
	                                    		?>
	                                    		<img src="<?php echo PROFILE_IMG_UPLOAD_FOLDER_PATH.$user->getProfileimageurlpath()?>" height="60px" alt="" class="image marginR10" />
                            ...
                            <div class="form-row row-fluid">
                                <div class="span12">
                                    <div class="row-fluid">
                                        ...
                                        <input class="span4" id="name" name="name" type="text" value="<?php echo $user->getName()?>" />
                                    </div>
                                </div>
                            </div>
                            <div class="form-row row-fluid">
                                <div class="span12">
                                    <div class="row-fluid">
                                        <label class="form-label span3" for="mci">MCI Registration Number:</label>
                                        <input class="span4" id="mci" name="mci" type="text" value="<?php echo $user->getMCI()?>" />
                                    </div>
                                </div>
                            </div>
                            <div class="form-row row-fluid">
                                <div class="span12">
                                    <div class="row-fluid">
                                        ...
                                        <input class="span4" id="email" name="email" type="text" value="<?php echo $user->getEmail()?>" />
                                    </div>
                                </div>
                            </div>
                            <div class="form-row row-fluid">
                                <div class="span12">
                                    <div class="row-fluid">
                                        ...
                                        <input class="span4" id="mobileno" name="mobileno" type="text" value="<?php echo $user->getMobileno()?>" />
                                    </div>
                                </div>
                            </div>
                            <div class="form-row row-fluid">
                                <div class="span12">
                                    <div class="row-fluid">
                                        ...
                                        <div class="left marginT5 marginR10">
                                            <input type="radio" name="gender" id="optionsRadios2" value="2" checked="checked" />
                                            Female
                                        </div>
                                        			<?php 
                                        			break;
                            ...
                            <div class="form-row row-fluid">
                                <div class="span12">
                                    <div class="row-fluid">
                                        ...
                                        <textarea class="span4 limit elastic" id="address" name="address" rows="3" cols="5"><?php echo $user->getAddress()?></textarea>
                                    </div>
                                </div>  
                            </div>
