                ...
                <div class="row-fluid">
					...
					<?php 
                        	if($_GET['eid']==1){
                                ...
                                <strong>Specializations Updated!</strong> 
                            </div>
                        		<?php 
                        	}else if($_GET['eid']==2){
                        		?>
                                ...
                                <button type="button" class="close" data-dismiss="alert">&times;</button>
                                <strong>Oh snap!</strong> Error updating specializations. Please try again later.
                            </div>
                        		<?php 
                        	}
                        ?>
                            ...
                            <div class="box">
                                ...
                                <div class="title">
                                    ...
                                    <h4>
                                        ...
                                        <span>Existing Specializations</span>
                                    </h4>
                                    ...
                                    <table class="responsive table table-bordered">
                                        ...
                                        <?php 
                                        	...
                                        	foreach($specialitydetails as $sp){
                                        		...
                                        		echo '<td><a href="deleteotherprofile.php?ac=1&tid='.$sp->getTid().'" title="Remove This" class="tip"><span class="icon12 icomoon-icon-remove"></span></a></td>';
                                        		echo '</tr>';
                                        		$index++;
                                        	}
                                        ?>
                                ...
                                <div class="content">
                                    ...
                                    <form class="form-horizontal" method="post" action="processotherprofile.php" />
                                        ...
                                        <div class="form-row row-fluid">
                                            <div class="span12">
                                                <div class="row-fluid">
                                                    <label class="form-label span4" for="checkboxes">Add More..</label>
                                                    <div class="span8 controls">   
                                                        <select name="specialityselect" id="specialityselect" style="width:100%;" >
                                                           <?php 
                                                           	include_once 'src/controllers/masterdatacontroller.php';
                                                           	$specialitylist = getSpecialityMasterList();
                                                           	foreach($specialitylist as $speciality){
                                                           		$shouldshow = true;
                                                           		foreach($specialitydetails as $sp){
                                                           			if($sp->getSpecialityid() == $speciality->getSpecialityid()){
                                                           				$shouldshow = false;
                                                           				break;
                                                           			}
                                                           		}
                                                           		if($shouldshow){
                                                           			echo '<option value="'.$speciality->getSpecialityid().'">'.$speciality->getSpecialitylabel().'</option>';
                                                           		}
                                                           	}
                                                           ?>
                                                          </select>
