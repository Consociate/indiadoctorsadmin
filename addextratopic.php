            ...
            <div class="contentwrapper"><!--Content wrapper-->
                ...
                <div class="heading">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <a href="extratopics.php" class="tip" title="Back to Topics">
                               Topics
                            </a> 
                            <span class="divider">
                                <span class="icon16 icomoon-icon-arrow-right"></span>
                        ...
                        <li class="active">Add Extra Topic</li>
                    </ul>
                ...
                <div class="row-fluid">
                            ...
                            <div class="box">
                                ...
                                <div class="title">
                                    ...
                                    <h4>
                                        ...
                                        <span>Add Extra Topic</span>
                                    </h4>
                                    
                                </div>
                                <div class="content">
                                   
                                    <form id="addform" class="form-horizontal" method="post" action="processextratopic.php" enctype="multipart/form-data"/>
                            ...
                            <div class="form-row row-fluid">
                                ...
                                <div class="span12">
                                    <div class="row-fluid">
                                        <label class="form-label span3" for="username">Upload (PDF/Doc/PPT only):</label>
                                ...
                                <div class="span12">
                                    <div class="row-fluid">
                                        ...
                                        <div class="span4 controls">
                                            <button type="submit" class="btn btn-info marginR10">Add Extra Topic</button>
                                            <a href="extratopics.php" class="btn btn-danger">Cancel</a>
                                        </div>
                                        </div>
                                    </div>
                                </div>   
