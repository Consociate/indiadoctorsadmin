        ...
        <div id="content" class="clearfix">
            <div class="contentwrapper"><!--Content wrapper-->
                ...
                <div class="heading">
                    ...
                    <h3>University Exam Question Papers</h3>                    
                ...
                <div class="row-fluid">
                        ...
                        <div class="centerContent">
                            ...
                            <ul class="bigBtnIcon">
                                <li>
                                    <a href="addexamquespost.php?sid=<?php echo $sid?>" title="Add Post" class="tipB">
					...
					<?php 
                        	if($_GET['eid']==1){
                                ...
                                <strong>Exam Questions Updated!</strong> 
                            </div>
                        		<?php 
                        	}else if($_GET['eid']==2){
                        		?>
                                ...
                                <button type="button" class="close" data-dismiss="alert">&times;</button>
                                <strong>Oh snap!</strong> Error updating your post. Please try again later.
                            </div>
                        		<?php 
                        	}
                        ?>
					...
					<div class="span12">
                            ...
                            $postlist = showPreviousQuestionPosts($sid);
                            $index = 0;
                            foreach($postlist as $post){
                            	echo '<tr>
                                    <td style="text-align:left;">'.($index+1).'</td>
                                    <td><a href="examquespost.php?sid='.$sid.'&tid='.$post->getPostid().'">'.$post->getPostlabel().'</a></td>
                                    <td>'.$post->getCreateby().'</td>';
                            	if($role == USER_ADMIN){
                            			echo '<td><a href="processexamquesposts.php?action=3&tid='.$post->getPostid().'&st=0&sid='.$sid.'" title="Remove This" class="tip">
