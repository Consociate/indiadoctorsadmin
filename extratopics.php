                ...
                <?php 
					...
					switch($role){
                        ...
                        <div class="centerContent">
                            ...
                            <ul class="bigBtnIcon">
                                <li>
                                    <a href="addextratopic.php" title="Add Extra Topic" class="tipB">
                                        <span class="icon brocco-icon-plus"></span>
                                        <span class="txt">Add Extra Topic</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
					...
					<?php 
                        	if($_GET['eid']==1){
                                ...
                                <button type="button" class="close" data-dismiss="alert">&times;</button>
                                <strong>Oh snap!</strong> Error updating your Topic. Please try again later.
                            </div>
                        		<?php 
                        	}
                        ?>
					...
					<div class="span12">
                            ...
                            $postlist = showExtratopicPosts();
                            $index = 0;
                            foreach($postlist as $post){
                            	echo '<tr>
                                    <td style="text-align:left;"><span class="icon16 iconic-icon-book-alt2"></span></td>
                                    <td><a href="extratopic.php?tid='.$post->getTid().'">'.$post->getPostlabel().'</a></td>
                            ...
                            if($role == USER_ADMIN){
                                                		...
                                                		echo '<a href="processextratopic.php?action=3&tid='.$post->getTid().'&st=0" title="Remove This" class="tip">
