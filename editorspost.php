            ...
            <div class="contentwrapper"><!--Content wrapper-->
                ...
                <div class="heading">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="active">Editor's Post</li>
                    </ul>
                ...
                <?php 
					...
					switch($role){
                        ...
                        <div class="centerContent">
                            ...
                            <ul class="bigBtnIcon">
                                <li>
                                    <a href="addeditorspost.php" title="Add Post" class="tipB">
					...
					<?php 
                        	if($_GET['eid']==1){
                                ...
                                <strong>Editor's Post Updated!.</strong> 
                            </div>
                        		<?php 
                        	}else if($_GET['eid']==2){
                        		?>
					...
					<div class="span12">
                            ...
                            $postlist = showEditorsPosts();
                            $index = 0;
                            foreach($postlist as $post){
                            	echo '<tr>
                                    <td style="text-align:left;"><span class="icon16 iconic-icon-book-alt2"></span></td>
                                    <td><a href="editorsposts.php?tid='.$post->getTid().'">'.$post->getPostlabel().'</a></td>
                            ...
                            if($role == USER_ADMIN){
                                                		...
                                                		echo '<a href="processeditorsposts.php?action=3&tid='.$post->getTid().'&st=0" title="Remove This" class="tip">
